...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('vendors/codemirror/codemirror.css') }}">
...
<script src="{{ asset('js/admin/codeEditor.js') }}"></script>
<script src="{{ asset('js/admin/tabs.js') }}"></script>
<script src="{{ asset('js/admin/tooltips.js') }}"></script>
<script src="{{ asset('js/admin/documentation.js') }}"></script>
